...
def get_config():
    config = {
        ...
        "save_path": "/root/autodl-tmp/zhjproject/DPSH/save/CNNF/CIFAR",
...
def train_val(config, bit):
    ...
    loss_output_path = f"/root/autodl-tmp/zhjproject/DPSH/RecordTrain/CNNF/loss_DPSH_CNNF_{config['dataset']}_{bit}.txt"
    mAP_output_path = f"/root/autodl-tmp/zhjproject/DPSH/RecordTrain/CNNF/mAP_DPSH_CNNF_{config['dataset']}_{bit}.txt"
...
def main():
    config = get_config()
    generate_cifar_index(config)
    for bit in config["bit_list"]:
        config["save_path"] = f"/root/autodl-tmp/zhjproject/DPSH/save/CNNF/CIFAR_{bit}"
        config["pr_curve_path"] = f"/root/autodl-tmp/zhjproject/DPSH/log/CNNF/DPSH_CNNF_{config['dataset']}_{bit}.json"
